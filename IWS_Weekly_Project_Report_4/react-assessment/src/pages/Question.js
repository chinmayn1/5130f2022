...
const Question = props => {
	...
	}, [AssessmentResponse, CloudinaryResponse])
		...
		if (!isFinish) {
			const UploadTimeID = setInterval(() => {
				...
				if (imageSrc) {
					...
					formData.append("upload_preset", "dagoexe5");
					dispatch(CloudinaryUpload(formData))
				}
			}, process.env.CLICKS_PER_DURATION || 2000)
	...
	return (
		<>
			<div className="d-flex flex-column align-items-center">
				...
				<Modal animation={false} show={showModal} centered>
